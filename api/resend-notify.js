// resend-notify.js — AdPulse LP
// Required env vars: RESEND_API_KEY, RESEND_FROM_EMAIL, CONTACT_EMAIL
// RESEND_SEGMENT_ID defaults to the AdPulse waitlist segment if not overridden.

const PRODUCT_SEGMENT_ID = 'f7ed9bd7-d5ed-44c6-9542-b2009794c05e'; // Waitlist-AdPulse
...
module.exports = async function handler(req, res) {
  ...
  const productName = product || 'AdPulse';
